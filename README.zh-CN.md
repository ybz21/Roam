...
<table>
  <tr>
    <td width="70%"><img src="docs/screenshots/overview.zh.png" alt="Roam Web 控制台 — 桌面概览"></td>
    <td width="30%"><img src="docs/screenshots/mobile-overview.zh.png" alt="Roam Web 控制台 — 手机概览"></td>
  </tr>
</table>

<sub>同一台开发机，从笔电和手机看到的样子——会话、蜂群、Agent 的实时状态都在同一处。</sub>
...
![会话列表：Agent 标签与筛选](docs/screenshots/sessions.zh.png)

**Agent、终端、文件树，同屏一览。** 看着 Claude Code 或 Codex 干活，旁边就能浏览、
打开文件；在手机上还有底部按键条可以直接敲。

![终端里运行的 Agent 与文件树](docs/screenshots/terminal.zh.png)
...
![手机上的 Roam：概览与蜂群仪表盘](docs/screenshots/mobile-office.zh.png)

概览和蜂群仪表盘都会自适应到手机(以下为真机截图):

<table>
  <tr>
    <td width="50%"><img src="docs/screenshots/mobile-overview.zh.png" alt="手机端概览"></td>
    <td width="50%"><img src="docs/screenshots/mobile-swarm.zh.png" alt="手机端蜂群仪表盘"></td>
  </tr>
</table>
...
<img src="docs/screenshots/mobile-chat.zh.png" alt="在手机上和 Claude Code 对话" width="300">
